...
namespace AVCapture
{
    ...
    public class FFTv1
    {
        ...
        /// <returns></returns>
        public double[] ProcessFft(Int16[] pcmSampleApplitudes) {
            ...
            ProcessFft(realComponents, complexComponents);
            return realComponents;
        }

        public void ProcessFft(double[] realComponents, double[] complexComponents) {
            int i, j, k, n1, n2, a;
            double c, s, t1, t2;
